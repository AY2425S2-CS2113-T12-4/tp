...
public class AddExpenseCommand extends Command {
     ...
     *
     * <p>The method first splits the input description into its components: the expense amount, category, and description.
     * It then calls the {@link BudgetManager#addExpenseToBudget(String, double, String)} method to add the expense to the
     * specified category of the budget.</p>
     *
     ...
     */
    @Override
    public void execute(Parser parser, BudgetManager budgetManager) throws InvalidInputException { //need to add UI and Saving class
